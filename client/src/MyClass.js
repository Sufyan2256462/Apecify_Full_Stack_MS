...
export default function MyClass() {
  ...
  const teacherName = 'Yashir Malik';
  ...
  return (
    <Box sx={{ display: 'flex', gap: 3, height: 'calc(100vh - 120px)' }}>
      ...
      {/* Students Modal */}
      <Dialog open={openStudentsModal} onClose={() => setOpenStudentsModal(false)} maxWidth="xl" fullWidth>
        <TeacherClassDetails teacherClass={selectedTeacherClass} />
      </Dialog>
    </Box>
  );
} 